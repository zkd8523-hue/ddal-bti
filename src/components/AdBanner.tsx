  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="block relative rounded-xl overflow-hidden border border-gray-700 hover:border-gray-500 hover:scale-[1.01] transition-all duration-200 group shadow-lg"
      >
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-4 md:p-5 flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-5">
          <div className="flex items-center gap-3 md:gap-5 flex-1">
            <div className="w-16 h-16 md:w-24 md:h-24 bg-white rounded-xl p-1.5 md:p-2 flex-shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300">
              <img
          ...
          <div className="w-full md:w-auto text-center px-4 py-2.5 bg-gray-700 group-hover:bg-gray-600 rounded-lg md:rounded-full text-[13px] md:text-xs font-bold text-gray-300 group-hover:text-white transition-all shrink-0 mt-1 md:mt-0 shadow-md">
            보러가기
          </div>
        </div>
        <p className="text-[9px] md:text-[10px] text-gray-600 text-center py-1 bg-gray-900 px-2 line-clamp-1 md:line-clamp-none border-t border-gray-800">
